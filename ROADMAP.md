...
| Item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Size |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- |
| **Draw the schema view's relations the way the taxonomy draws them** — rigid right angles, out of a class, along a lane clear of every node, and back down into the other, rather than the curves it uses now. The taxonomy version earns its keep by using the empty canvas above and below the diagram instead of forcing every line through the crowded middle. **Not the same problem twice, though:** the taxonomy's layout is derived and its nodes cannot be dragged, so lanes can be recomputed freely and there is a predictable top and bottom to the diagram. Schema classes are placed by hand, anywhere, and moved while you watch — so the lanes have to be found from wherever the classes happen to be, and re-found on every drag. Worth checking what that costs before committing to it. _(todo 32)_ | M    |
