 ...
 *
 * The double-tap tolerances used to live here too. They moved to the design system once the
 * class node needed them as well, since two UI modules may not import one another.
 */
